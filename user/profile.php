...
$sell = mysqli_query($con , "select * from `user` where `id` = '$user_id'");
...
<center>
 <img style=" width: 200px; border-radius: 50%; border:5px solid #000; margin-top:90px; margin-bottom:20px; "
  src="userimg/<?php print $s['img']  ?>" controls class="content_image"></div></a>
 <br>
 <center>
