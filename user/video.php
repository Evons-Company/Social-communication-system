...
?>
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="profile.php?id=<?php echo $user_id ?>">الصفحة الشخصية</a></li>
        </ul>
      </li>
      <li>
        <a href="password_one.php ?id=<?php echo $user_id ?>">
          <i class='bx bx-cog' ></i>
          <span class="link_name">الاعدادات</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="password_one.php ?id=<?php echo $user_id ?>">الاعدادات</a></li>
        </ul>
      </li>
      <li>
